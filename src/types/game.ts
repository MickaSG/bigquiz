...
// Profil persistant d'un joueur (gardé entre les parties)
export interface SavedPlayer {
  id: string;
  name: string;
  avatar: string;
  color: string; // gradient pour carte
  emoji: string; // petit émo de personnalité
  bestScore: number;
  bestMode: string; // "classique" | "survie" | "blitz"
  bestAccuracy: number;
  bestStreak: number;
  totalGames: number;
  totalCorrect: number;
...
export const DEFAULT_PLAYERS: SavedPlayer[] = [
  {
    id: 'micka',
    name: 'Micka',
    avatar: '🧠',
